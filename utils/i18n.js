...
const TRANSLATIONS = {
  ...
  自动匹配设备的亮暗模式: { 'zh-CN': '自动匹配设备的亮/暗模式设置', en: 'Auto-match device light/dark mode' },
  始终使用明亮界面: { 'zh-CN': '始终使用明亮界面，适合白天使用', en: 'Always bright, best for daytime' },
  暗色背景护眼: { 'zh-CN': '暗色背景护眼，适合夜间使用', en: 'Dark background, best for night use' },
  预览模式提示: { 'zh-CN': '选择「跟随系统」时，小程序会根据您手机的系统设置自动切换，无需手动操作。', en: 'With "Follow System", the app switches automatically based on your device settings.' },

  // ========== 字体大小 ==========
  文字大小: { 'zh-CN': '文字大小', en: 'Font Size' },
  小: { 'zh-CN': '小', en: 'Small' },
  标准: { 'zh-CN': '标准', en: 'Standard' },
  大: { 'zh-CN': '大', en: 'Large' },
  特大: { 'zh-CN': '特大', en: 'Extra Large' },
  预览效果: { 'zh-CN': '预览效果', en: 'Preview' },
  今日断食进度: { 'zh-CN': '今日断食进度', en: 'Today\'s Fasting Progress' },
  '已坚持 6 小时 23 分钟': { 'zh-CN': '已坚持 6 小时 23 分钟', en: '6h 23m completed' },
  字体预览文本: { 'zh-CN': '这是一段示例文字，用于预览当前字体大小的显示效果。调整上方滑块即可看到变化。', en: 'This is sample text to preview the current font size. Adjust the slider to see changes.' },
  字体提示2: { 'zh-CN': '字体大小仅影响小程序内的显示，不会改变系统字体设置。', en: 'Font size only affects this app, not system settings.' },
